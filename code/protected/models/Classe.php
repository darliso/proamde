...
class Classe extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'classeHasCaracteristicas' => array(self::HAS_MANY, 'ClasseHasCaracteristica', 'classe_id'),
			'classeHasPerguntas' => array(self::HAS_MANY, 'ClasseHasPergunta', 'classe_id'),
			'turmas' => array(self::HAS_MANY, 'Turma', 'classe_id'),
		);
	}
